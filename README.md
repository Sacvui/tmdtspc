...
```bash
# Clone repository
git clone https://github.com/Sacvui/tmdtspc.git
cd tmdt
...
1. **Kết nối GitHub repository**:
   ...
   - Chọn repository: `Sacvui/tmdtspc`
...
2. **Cấu hình Build Settings**:
   ...
   ⚠️ **QUAN TRỌNG**: Nếu repository GitHub có thư mục `tmdt` bên trong, bạn PHẢI set **Root Directory = `tmdt`** trong Vercel Settings. Xem hướng dẫn chi tiết: [VERCEL_ROOT_DIRECTORY_SETUP.md](VERCEL_ROOT_DIRECTORY_SETUP.md)
...
- **Contact**: [GitHub Issues](https://github.com/Sacvui/tmdtspc/issues)

## 🔗 Links

- **Repository**: https://github.com/Sacvui/tmdtspc
- **Issues**: https://github.com/Sacvui/tmdtspc/issues
- **Vercel Deployment**: https://tmdt.vercel.app
